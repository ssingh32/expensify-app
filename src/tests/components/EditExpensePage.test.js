...
let startEditExpense, startRemoveExpense, handleModalOption, history, wrapper;

beforeEach(() => {
    startEditExpense = jest.fn();
    startRemoveExpense = jest.fn();
    handleModalOption = jest.fn();
...
//     expect(wrapper).toMatchSnapshot();
//     wrapper.find('button').simulate('click');
//     expect(handleModalOption).toHaveBeenLastCalledWith(false);
// });
